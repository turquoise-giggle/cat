![Saitama](https://telegra.ph/file/d8a8766a2aeffac45bf7b.jpg)
# Cat Robot  
...
A modular Telegram Python bot running on python3 with a sqlalchemy database and an entirely themed persona designed specifically for CatUserbotSupport. 

Can be found on telegram as [CatRobot](http://t.me/CatUsersRobot).

This is not official Cat's Robot, it's forked and modified version of SaitamaRobot so The Support group can be reached out to at [One punch support](https://t.me/OnePunchSupport), where you can ask for help about [SaitamaRobot](https://t.me/SaitamaRobot), discover/request new features, report bugs, and stay in the loop whenever a new update is available. 
